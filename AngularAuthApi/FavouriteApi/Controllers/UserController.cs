...
namespace FavouriteApi.Controllers
{
    ...
    public class UserController : ControllerBase
    {
        ...
        {
            var Uname = _appDbcontext.Users.Where(u => u.Username == user.username).FirstOrDefault();
            if (!PasswordHasher.VerifyPassword(user.currentpassword, Uname.Password))
            {
                return BadRequest(new
                {
                    Message = "password is incorrect"
